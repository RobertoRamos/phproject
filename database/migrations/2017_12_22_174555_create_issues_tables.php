...
class CreateIssuesTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('issues', function (Blueprint $table) {
            ...
            $table->string('name');
            $table->string('size_estimate', 20)->nullable();
            ...
            $table->foreign('priority_value')->references('value')->on('issue_priorities');
            $table->double('hours_total')->nullable();
            $table->double('hours_remaining')->nullable();
            $table->double('hours_spent')->nullable();
            $table->string('repeat_cycle', 20)->nullable();
